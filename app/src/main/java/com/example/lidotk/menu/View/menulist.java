package com.example.lidotk.menu.View;
...
import com.example.lidotk.menu.Adapter.SectionedBaseAdapter;

/**
 * Created by lidotk on 2017/4/17.
 */
public class menulist extends ListView implements OnScrollListener {
    ...
    public void setOnItemClickListener(menulist.OnItemClickListener listener) {
