...
public class foodAdapter extends BaseAdapter {
    ...
    private List<Food> shopProducts;
    private LayoutInflater mInflater;

    public foodAdapter(Context context, List<Food> shopProducts) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.commodityName.setText(shopProducts.get(position).getName());
        ...
        // viewHolder.settlement.setOnClickListener(new View.OnClickListener(){});
