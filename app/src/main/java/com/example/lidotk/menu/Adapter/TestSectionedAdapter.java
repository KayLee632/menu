...
public class TestSectionedAdapter extends SectionedBaseAdapter {
    ...
    public TestSectionedAdapter(Context context, List<FoodType> pruductCagests){
    ...
    public View getItemView(final int section, final int position, View convertView, ViewGroup parent) {
        ...
        final Food product = pruductCagests.get(section).getProduct().get(position);
        ...
        getImageByUrl.setImage(viewHolder.head, product.getPicture().getUrl());
